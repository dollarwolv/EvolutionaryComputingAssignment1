...
def plot_fit_per_gen(path: str, mode: str) -> None:
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Plot fitness per generation")
    parser.add_argument("--path", required=True, help="Folder containing database.db")
    parser.add_argument("--mode", choices=["min", "max"], default="min", help="Whether lower or higher fitness is better")
    args = parser.parse_args()
    plot_fit_per_gen(args.path, args.mode)
